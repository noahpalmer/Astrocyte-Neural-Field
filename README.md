...
**Simulation length:**
The simulations performed in numericalphase.m can be time-consuming depending on the chosen resolution. For example, on a laptop running Windows 11 Home, a simulation with a 50 × 50 resolution  takes approximately  to complete.
